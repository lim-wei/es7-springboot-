...
import com.liaoyuan.dianping.controller.admin.AdminController;
...
public class ControllerAspect {
    ...
    @Around("execution(* com.liaoyuan.dianping.controller.admin..*.*(..)) && @annotation(org.springframework.web.bind.annotation.RequestMapping)")
